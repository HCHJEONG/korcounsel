...
**동일 날짜 후속 교정:** 아래 감사의 lawgo 35개는 `current-lawgo-4`로
전체 번호 비교를 교정하고 새 reader·필드를 발행했다. canonical 병합은
없다. [최신 결과](lawgo-full-docket-correction.md).

**2026-09-15 후보 감사:** 기존·현재 자료의 중복 후보와 번호 변경 3쌍,
lawgo 충돌 35개를 보존 근거로 조사했다. 전체 병합 번호를 대조하면 35개는
메타데이터가 일치하지만 운영 연결 변경과 canonical 승인은 아직이다.
[후보 목록·비교 규칙·보류 사유](identity-audit-20260915.md).
