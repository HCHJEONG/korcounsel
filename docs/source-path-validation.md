...
**2026-09-15 후속:** 아래 번호 변경 후보 3쌍의 보존 원본 hash와 기존
Parquet 본문을 다시 대조했다. 공통 본문은 확인했으나 전체 동일성·공식
대체 관계는 보류다. 신규 live 관찰이나 registry 변경은 없었다.
[후속 동일성 감사](identity-audit-20260915.md).

> **중요 발견과 설계 영향 — 2026-09-10:** 기존 scourt contId 2061329와 lawgo serialno 194079/192890는 현재 상세 조회에서 미조회됐고, 동일 사건 검색에서 각각 2025000017702와 607465/601365가 발견됐다. 이는 출처 ID의 영구 안정성을 전제할 수 없다는 실측 근거다. 공식 번호 변경 원인이나 문서 전체 동일성을 확인한 것은 아니다. **사용자 결정에 따라 신규 canonical은 출처 ID와 독립적으로 발급하고, contId/serialno는 관찰·재조회·출처 연결 키로 보존한다.** [확정 정책과 구현 대기 사항](case-identity.md)을 따른다.
