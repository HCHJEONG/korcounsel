...
**품질 교정 후 최신 결과 — 2026-09-15:** 아래 기간 수집은 410개 source ID의
실행 이력이다. 시험 23개와 합친 고정 433개를 재집계하고 법원명 공백 충돌
4개를 교정했다. 최신 lawgo/조문 수치, reader별 v6 revision, 로컬 433행
aggregate와 보류 근거는 [품질 기준선 기록](quality-baseline-20260915.md)을
따른다. 아래 v3~v6 발행 당시 파일과 숫자는 덮어쓰지 않는다.
