...
**일반 검색 연결 후속 — 2026-09-11:** 기존 8행의 이미지·조문 보강을 일반 검색 경로에 연결했다. 아래 과거 4개 현재 본문 표본의 미연결 5곳은 manifest 기준 FAILED 3곳·PENDING 2곳이다. [최신 구현·검증 범위](legacy-reader-enrichment.md).
