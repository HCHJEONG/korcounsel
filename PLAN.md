...
**오래된 구간부터 3개월 증보 — 2026-09-15:** 기존 89,130행의 마지막 선고일은 2024-09-27이다. 현재 9월 목록 87건 중 기존 대응 30건·미대응 후보 57건이며, 10~12월 미대응 후보는 353건이다. 첫 작업은 9월 경계 보완 57건 → 10~12월 353건 순서로 잡는다. 이번에는 목록 감사까지 실행했고 상세 수집은 아직이다. 날짜 범위/페이지 재개를 관리자 영속 수집 경로에 연결한 뒤 실행한다. 이후 2025년부터 순차적으로 2026-08-31까지 확대한다. [근거·한계](docs/chronological-ingestion-window.md).
