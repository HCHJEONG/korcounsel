...
**최신 교정 — 2026-09-15:** 전체 사건번호 비교 로직을 개선하고 기존 충돌
35건의 본문·60필드를 재발행했습니다. 고정 433건에서 lawgo 연결은
EXACT 364 / CONFLICT 0 / UNMATCHED 69입니다. 조문 6,554곳을 보존했으며
조문 취득 실패 23곳과 법령 버전·폐기 검토는 남아 있습니다.
[원인과 교정 결과](docs/lawgo-full-docket-correction.md). 아래 수치는 이전 이력입니다.

**동일성 감사 — 2026-09-15:** 다른 출처 번호의 후보 300묶음과 번호 변경
후보 3쌍을 조사했습니다. lawgo 충돌 35개는 전체 병합 번호와 상세 메타데이터의
일치를 확인했으며 운영 교정·재발행은 남아 있습니다.
[검토 기록과 남은 판단](docs/identity-audit-20260915.md).
