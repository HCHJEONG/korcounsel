...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: 'backend/.venv-reader/bin/python scripts/reader_test_server.py', url: 'http://127.0.0.1:8000/api/health', reuseExistingServer: false, gracefulShutdown: { signal: 'SIGINT', timeout: 10000 } },
  ],
